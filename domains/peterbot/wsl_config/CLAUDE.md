...
- `FITNESS.md` — weight / cut / calories / mobility / goal phases (protein target + framing) / **gym training log + adaptive plan** (skills `log-workout`, `log-cardio`, `training-plan`) / `/fitness/*` endpoints
